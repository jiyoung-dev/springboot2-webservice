...
/**
 * JPA와 연동한 경우, 테스트에 @WebMvcTest 대신 @SpringBootTest와 TestRestTemplate 사용.
 * */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)  //테스트를 위한 랜덤포트 생성
